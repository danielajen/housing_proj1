...
//     },
//     {
//       keywords: ["thank you", "thank you for your help", "thanks", "bye", "see ya", "see you", "thank"],
...
//                 {/* Real person buttons */}
//                 {msg.showButtons && (
//                   <div style={{ display: 'flex', gap: '8px', marginTop: '8px', justifyContent: msg.sender === 'user' ? 'flex-end' : 'flex-start' }}>
//                     <button 
