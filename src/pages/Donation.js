      ...
      <div style={{ backgroundColor: "#f3f4f6", padding: "60px 20px" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: "1.1rem", lineHeight: "1.8" }}>
            As a student-built initiative hosted on open infrastructure, we rely on community support. Our work
            involves manually aggregating and interpreting datasets from Statistics Canada, CMHC, and provincial
            portals — making them digestible for the public.
          </p>
          <p style={{ fontSize: "1.1rem", lineHeight: "1.8", marginTop: "20px" }}>
            Your donation goes directly toward keeping this work sustainable and open. No paywalls. No ads. Just
            clear data for civic change.
          </p>
        </div>
      </div>
    </div>
